...
#LOST TIME:
#What I forgot was that the new Jokers "J" to insert at the very end of CardLabels already existed between Q and T within the array!
...
#file_path = 'AOC071223sample3.txt'
...
if detectOfAKinds(readString("AK3A4 111"))[2] != 1:
	print("Test 1 [AK3A4]: Error: Found["+str(detectOfAKinds(readString("AK3A4 111"))[2])+"], Expected[1]")
...
else: print("Test J3 [TTJ98]: Success!")
...
else: print("Test J5-1 [T55J5]: Success!")
...
else: print("Test J5-2 [KTJJT]: Success!")
...
else: print("Test J5-3 [QQQJA]: Success!")
...
else: print("Test J5-4 [KJJJT]: Success!")
...
else: print("Test J6-1 [KJJJJ]: Success!")
...
else: print("Test J6 [AAAAJ]: Success!")

#cL1GrCl2:
if cL1GrCl2("QQQQ2","JKKK2") == 1:
	print("Test cL1GrCl2 1 [QQQQ2 > JKKK2]: Success!")
else: print("Test cL1GrCl2 1 [QQQQ2 > JKKK2]: Error!")
