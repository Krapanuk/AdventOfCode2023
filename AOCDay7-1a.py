...
def detectOfAKinds(hand):
	...
	manys.sort()
	print(manys)
	if manys[len(manys)-1] > 1:
		strongestValue = manys[len(manys)-1]-1
		print("T1 "+str(strongestValue))
		if manys[len(manys)-2] > 1:
			strongestValue = strongestValue + manys[len(manys)-2] -1+containsJ
			print("T2 "+str(strongestValue))
	if manys[len(manys)-1] > 2:
		strongestValue = manys[len(manys)-1]
		print("T3 "+str(strongestValue))
		if manys[len(manys)-2] > 1:
			strongestValue = strongestValue + manys[len(manys)-2] -1+containsJ
			print("T4 "+str(strongestValue))
	if manys[len(manys)-1] > 3:
		strongestValue = manys[len(manys)-1]+1+containsJ
		print("T5 "+str(strongestValue))
	strongestValue += containsJ
	print("T6 "+str(strongestValue))
...
if detectOfAKinds(readString("23456 111"))[2] != 0:
	print("Test 0: Error: Found["+str(detectOfAKinds(readString("23456 111"))[2])+"], Expected[0]")
else: print("Test 0: Erfolg!")
if detectOfAKinds(readString("A23A4 111"))[2] != 1:
	print("Test 1: Error: Found["+str(detectOfAKinds(readString("A23A4 111"))[2])+"], Expected[1]")
else: print("Test 1: Erfolg!")
if detectOfAKinds(readString("23432 111"))[2] != 2:
	print("Test 2: Error: Found["+str(detectOfAKinds(readString("23432 111"))[2])+"], Expected[2]")
else: print("Test 2: Erfolg!")
if detectOfAKinds(readString("TTT98 111"))[2] != 3:
	print("Test 3: Error: Found["+str(detectOfAKinds(readString("TTT98 111"))[2])+"], Expected[3]")
else: print("Test 3: Erfolg!")
if detectOfAKinds(readString("39933 111"))[2] != 4:
	print("Test 4: Error: Found["+str(detectOfAKinds(readString("39933 111"))[2])+"], Expected[4]")
else: print("Test 4: Erfolg!")
if detectOfAKinds(readString("TTTT2 111"))[2] != 5:
	print("Test 5: Error: Found["+str(detectOfAKinds(readString("TTTT2 111"))[2])+"], Expected[5]")
else: print("Test 5: Erfolg!")
if detectOfAKinds(readString("AAAAA 111"))[2] != 6:
	print("Test 6: Error: Found["+str(detectOfAKinds(readString("AAAAA 111"))[2])+"], Expected[6]")
